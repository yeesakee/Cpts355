...
calc_collatz_seq_test4 = TestCase (assertEqual "calc_collatz_seq_test4" 
                                  ...
                                  178,89,268,134,67,202,101,304,152,76,38,19,58,29,88,44,22,11,
...
longest_collatz_seq_test4 = TestCase (assertEqual "longest_collatz_seq4" 
                                  ...
                                  (longest_collatz_seq 27) )                        
longest_collatz_seq_test5 = TestCase (assertEqual "longest_collatz_seq5" 
                                  [97,292,146,73,220,110,55,166,83,250,125,376,188,94,47,142,71,214,
                                  107,322,161,484,242,121,364,182,91,274,137,412,206,103,310,155,466,
                                  233,700,350,175,526,263,790,395,1186,593,1780,890,445,1336,668,334,
                                  167,502,251,754,377,1132,566,283,850,425,1276,638,319,958,479,1438,
                                  719,2158,1079,3238,1619,4858,2429,7288,3644,1822,911,2734,1367,4102,
                                  2051,6154,3077,9232,4616,2308,1154,577,1732,866,433,1300,650,325,976,
                                  488,244,122,61,184,92,46,23,70,35,106,53,160,80,40,20,10,5,16,8,4,2,1]
...
wsu_games_modified = [
    (2020, [("NMSU",(58,7)), ("UNCO",(59,17)), ("HOU",(31,24)), ("UCLA",(67,67)), ("UTAH",(13,38)), 
            ("ASU",(34,38)), ("COLO",(41,10)), ("ORE",(35,37)), ("CAL",(20,33)), ("STAN",(49,22)), 
            ("ORST",(54,53)), ("WASH",(13,31)), ("AFA",(21,31))]),
    (2021, [("ORST",(18,28)), ("ORE",(29,43)), ("USC",(13,38)), ("UTAH",(28,45))]),
    (2022, [("USU",(23,26)), ("PORT ST.",(44,24)), ("USC",(14,45)), ("UTAH",(13,24)), ("CAL",(21,6)),
            ("ORST",(31,24)), ("STAN",(34,31)), ("BYU",(19,21)), ("ASU",(34,21)), ("ORE",(24,38)), 
            ("ARIZ",(44,18)), ("WASH",(40,13)), ("CMU",(21,24))] )
            ]
wsu_games_2019 = [
...
wsu_games_empty = []::[(Int, [([Char], (Int, Int))])]
            
game_scores_test1 = TestCase (assertEqual "game_scores_test1" 
                                  []
                                  (sort $ game_scores wsu_games_empty "BERKLEY") ) 
...
game_scores_test4 = TestCase (assertEqual "game_scores_test4" 
                                  (sort [(13,38)])
                                  (sort $ game_scores wsu_games_2019 "UTAH") )

wins_by_year_test1 = TestCase (assertEqual "wins_by_year_test1" 
                                  []
                                  (sort $ wins_by_year wsu_games_empty) )  
wins_by_year_test2 = TestCase (assertEqual "wins_by_year_test2" 
                                  (sort [(2019,5),(2020,0),(2021,7)])  
                                  (sort $ wins_by_year wsu_games_modified) )       
wins_by_year_test3 = TestCase (assertEqual "wins_by_year_test3" 
                                  (sort [(2019,6)])  
                                  (sort $ wins_by_year wsu_games_2019) )                                              
...
tests = TestList [ 
                   -- Problem 1 tests: merge_sorted
                   TestLabel "merge_sorted- test1 " merge_sorted_test1,
                   ...
                   -- Problem 3a tests: calc_collatz_seq
                   ...
                   -- Problem 3b tests: longest_collatz_seq
                   ...
                   TestLabel "longest_collatz_seq- test4 " longest_collatz_seq_test4,
                   TestLabel "longest_collatz_seq- test5 " longest_collatz_seq_test5,

                   -- Problem 4a tests: game_scores
                   ...
                   -- Problem 4b tests: wins_by_year
                   TestLabel "wins_by_year- test1 " game_scores_test1,
                   TestLabel "wins_by_year- test2 " game_scores_test2,
                   TestLabel "wins_by_year- test3 " game_scores_test3,

                   -- Problem 5 tests: compress_str

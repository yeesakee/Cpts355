...
longest_collatz_seq num =
     ...
     where
          ...
          longest_collatz_seq_helper [] [] xnum ynum = []
          longest_collatz_seq_helper xL [] xnum ynum = xL
          longest_collatz_seq_helper [] yL xnum ynum = yL
